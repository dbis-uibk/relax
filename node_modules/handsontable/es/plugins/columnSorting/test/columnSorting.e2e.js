describe('ColumnSorting', function () {
  ...
  describe('should return sorted properly data when maxRows or / and minSpareRow options are set', function () {
    ...
    testSorting('maxRows < data.length', { rows: 9, columns: 9, maxRow: 6, sortIndex: 1, sortOrder: 'desc' }, { dataLength: 6, expectations: [{ rowIndex: 0, columnIndex: 2, value: 'C6' }] });

    testSorting('maxRows > data.length', { rows: 8, columns: 8, maxRow: 20, sortIndex: 1, sortOrder: 'desc' }, { dataLength: 8, expectations: [{ rowIndex: 0, columnIndex: 2, value: 'C8' }] });

    testSorting('minSpareRows is set; maxRows < data.length', { rows: 9, columns: 9, maxRow: 5, minSpareRows: 3, sortIndex: 1, sortOrder: 'desc' }, { dataLength: 5, expectations: [{ rowIndex: 0, columnIndex: 2, value: 'C5' }] });

    testSorting('minSpareRows is set; maxRows === data.length', { rows: 6, columns: 6, maxRow: 9, minSpareRows: 3, sortIndex: 1, sortOrder: 'desc' }, { dataLength: 6 + 3, expectations: [{ rowIndex: 0, columnIndex: 2, value: 'C6' }] });

    testSorting('minSpareRows is set; maxRows > data.length', { rows: 9, columns: 9, maxRow: 15, minSpareRows: 2, sortIndex: 1, sortOrder: 'desc' }, { dataLength: 9 + 2, expectations: [{ rowIndex: 0, columnIndex: 2, value: 'C9' }] });
  });
});
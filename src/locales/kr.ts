...
export const langKR: Partial<typeof langEN> = {
	"db.messages.parser.error-duplicate-variable": "변수 이름 중복: __name__",
	"db.messages.parser.error-invalid-date-format": "\"__str__\"  유효하지 않은 날짜; 형식: YYYY-MM-DD",
	"db.messages.parser.error-group-duplicate-header": " 헤더 중복: __name__",
	"db.messages.parser.error-group-unknown-header": "알 수 없는 헤더:  __name__",
	...
	"db.messages.parser.error-group-non-unique-attribute": "__index__ 열에서 고유하지 않은 속성 __name__",
	...
	"db.messages.translate.error-relation-not-found": "릴레이션  \"__name__\"을 찾을 수 없음",
	...
	"db.messages.translate.error-variable-name-conflict": "이름 충돌: 릴레이션 이름 \"__name__\" 은 이미 존재함",
	"db.messages.translate.error-variable-cyclic-usage": "변수  \"__name__\"의 순환 사용이 감지됨",
	"editor.codemirror-placeholder[0]": "쿼리는 이곳에 표시된다 ...",
	"editor.codemirror-placeholder[1]": "",
	"editor.codemirror-placeholder[2]": "키보드 단축키:",
	"editor.codemirror-placeholder[3]": "\tstatement 실행:    [CTRL]+[RETURN]",
	"editor.codemirror-placeholder[4]": "\tselection 실행:    [CTRL]+[SHIFT]+[RETURN]",
	"editor.codemirror-placeholder[5]": "\t자동 완성:         [CTRL]+[SPACE]",
